...
from testdata.test_parameters.film_params import default_params, sort_params, page_num_params, page_size_params,\
                                                 film_id_params, genre_params, combined_params
...
@pytest.mark.asyncio
async def test_film_list(make_get_request, query_params: dict, expected_data_file: str,
...
@pytest.mark.parametrize("film_id, expected_data_file, status",
                         [*film_id_params])
@pytest.mark.asyncio
async def test_film_by_id(make_get_request, film_id: str, expected_data_file: str, status: int):
    """
